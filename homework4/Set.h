...
template <typename ItemType>
inline void Set<ItemType>::swap(Set<ItemType>& other)
{
      // Swap head pointers
...
template <typename ItemType>
inline Set<ItemType>::Set(const Set<ItemType>& other)
{
    createEmpty();
...
template <typename ItemType>
inline void butNot(const Set<ItemType>& s1, const Set<ItemType>& s2, Set<ItemType>& result)
{
